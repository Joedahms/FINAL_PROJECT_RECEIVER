...
void throttle_test();
# 78 "main.c" 2
# 1 "./../pc_pwm.X/pc_pwm.h" 1
# 11 "./../pc_pwm.X/pc_pwm.h"
void PWM_init();
# 79 "main.c" 2
# 1 "./../adc.X/adc.h" 1
# 11 "./../adc.X/adc.h"
...
int main( int argc, char** argv ) {
    ...
    while( 1 )
    {
        test_val = set_throttle(forward_flag);
        PDC0L = test_val;
...
int set_throttle(int forward_flag)
{
    int i;
    int step_size = 0;
    uint8_t dir_div = 0;
